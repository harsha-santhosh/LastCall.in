...
/**
 * Created by harshasanthosh on 02/12/17.
 */

public class SimpleFileDialog {
    private int FileShow     = -1;
    ...
    {
        if (file_select_type.equals("FileShow"))          Select_type = FileShow;
        else if (file_select_type.equals("FileOpen"))          Select_type = FileOpen;
        ...
        m_context = context;
        if(Select_type == FileShow) {
            m_sdcardDirectory = Environment.getExternalStorageDirectory().getAbsolutePath() + "/lastcallin/contacts/";
        }
        else if(Select_type == FileOpen)
        {
            m_sdcardDirectory = Environment.getExternalStorageDirectory().getAbsolutePath()+ "/lastcallin/contacts/";
        }
        ...
        dialogBuilder.setPositiveButton("OK", new DialogInterface.OnClickListener()
        {
            ...
            public void onClick(DialogInterface dialog, int which)
            {
                ...
                if (m_SimpleFileDialogListener != null){
                    {
                        if (Select_type == FileOpen || Select_type == FileSave || Select_type == FileShow)
                        {
    ...
    private List<String> getDirectories(String dir)
    {
        ...
        try
        {
            ...
            if (! m_dir.equals(Environment.getExternalStorageDirectory().getAbsolutePath()) ) dirs.add("..");
            ...
            for (File file : dirFile.listFiles())
            {
                ...
                else if (Select_type == FileSave || Select_type == FileOpen || Select_type == FileShow)
                {
                                                             ...
                                                             DialogInterface.OnClickListener onClickListener)
    {
        ...
        if (Select_type == FileShow    ) m_titleView1.setText("Folder Location:");
    ...
    private void updateDirectory()
    {
        ...
        //#scorch
        if (Select_type == FileSave || Select_type == FileOpen || Select_type == FileShow)
        {
